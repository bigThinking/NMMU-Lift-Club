...
public class ClientInfo {
    ...
    private HashMap<String, Match> matches = new HashMap<>(5);
    private ArrayList<Ride> listedRides = new ArrayList<Ride>();
    
    private Queue messages = new LinkedBlockingQueue();
    ...
    public ArrayList<Ride> getListedRides() {
        return listedRides;
    }
    ...
    {
        return "userId: " + userId + ", authToken: "+ authToken + ", webSockid: " + webSockId;
    }
}
