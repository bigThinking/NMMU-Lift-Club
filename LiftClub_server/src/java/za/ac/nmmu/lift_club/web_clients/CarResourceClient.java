 ...
 * USAGE:
 * <pre>
 *        CarResourceClient client = new CarResourceClient();
...
public class CarResourceClient {
    ...
    public CarResourceClient(String authToken) {
    ...
    public Response setCurrentCar(String carVRN) throws ClientErrorException {
        return addHeaders(webTarget.path(java.text.MessageFormat.format("{0}", new Object[]{carVRN})).request()).post(null, Response.class);
    }

    public String getCar_JSON(String carVRN) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("{0}", new Object[]{carVRN}));
        return addHeaders(resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON)).get(String.class);
    }

    public String getCar_TEXT(String carVRN) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("{0}", new Object[]{carVRN}));
    ...
    public String getCars_JSON() throws ClientErrorException {
        WebTarget resource = webTarget;
        return addHeaders(resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON)).get(String.class);
    }

    public String getCars_TEXT() throws ClientErrorException {
        WebTarget resource = webTarget;
        return addHeaders(resource.request(javax.ws.rs.core.MediaType.TEXT_PLAIN)).get(String.class);
    }
