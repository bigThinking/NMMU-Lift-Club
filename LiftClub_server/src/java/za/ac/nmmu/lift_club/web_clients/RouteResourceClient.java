 ...
 * @author s210036575
 */
public class RouteResourceClient {
    ...
    public RouteResourceClient(String authToken) {
    ...
    public String getRoutes_TEXT() throws ClientErrorException {
        WebTarget resource = webTarget;
    ...
    public Response addRoute(Object requestEntity) throws ClientErrorException {
    ...
    public String getRoutePoints_TEXT(String routeId) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("{0}", new Object[]{routeId}));
        return addHeaders(resource.request(javax.ws.rs.core.MediaType.TEXT_PLAIN)).get(String.class);
    }
