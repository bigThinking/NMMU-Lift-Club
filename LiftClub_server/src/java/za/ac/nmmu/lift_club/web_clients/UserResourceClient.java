...
public class UserResourceClient {
    ...
    public UserResourceClient(String authToken) {
    ...
    public String getProfile_TEXT() throws ClientErrorException {
        WebTarget resource = webTarget;
    ...
    public Response changeProfileInfo_TEXT(Object requestEntity) throws ClientErrorException {
        return addHeaders(webTarget.request(javax.ws.rs.core.MediaType.TEXT_PLAIN))
                .post(javax.ws.rs.client.Entity.entity(requestEntity, javax.ws.rs.core.MediaType.TEXT_PLAIN), Response.class);
    }
