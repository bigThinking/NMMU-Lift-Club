 ...
 * @author s210036575
 */
public class RatingResourceClient implements URL{
...
//private static final String BASE_URI = "http://192.168.5.125:8060/lift_club";
    ...
    public RatingResourceClient(String authToken, Client client) {
     //   if(client == null)
            this.client = javax.ws.rs.client.ClientBuilder.newBuilder().build();//.sslContext(getSSLContext())
     //   else this.client = client;

        webTarget = this.client.target(BASE_URI).path("rating");
    ...
    public void updateSystemRating(Object requestEntity, String rideId, String rating) throws ClientErrorException {
        addHeaders(webTarget.path(java.text.MessageFormat.format("ride/{0}/{1}", new Object[]{rideId, rating})).request(javax.ws.rs.core.MediaType.APPLICATION_JSON))
                .post(javax.ws.rs.client.Entity.entity("", javax.ws.rs.core.MediaType.APPLICATION_JSON));
    }

    public void giveRideRating(Object requestEntity) throws ClientErrorException {
        addHeaders(webTarget.path("ride").request(javax.ws.rs.core.MediaType.APPLICATION_JSON))
